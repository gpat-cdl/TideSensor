...
#define RADIO_RX_PIN 7 // connect to Heltec TX  standard Serial1 RX
#define RADIO_TX_PIN 8 // connect to Heltec RX  standard Serial1 TX
...
void powerdown()
 {
  ...
  waitAsecond(5);
  Serial.println("Going to sleep for about 15 sec");
  waitAsecond();
