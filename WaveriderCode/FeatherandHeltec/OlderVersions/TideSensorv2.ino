...
#define SLEEPTIME 300 /* Sleeptime in seconds */
#define TESTTIME 10   

#define IRQ_PIN 2 // for VL53
#define XSHUT_PIN 3
...
void setup() {
  ...
  // 6/24/2026 added io pin to detect whether 0 or V  to change time interval between measurments 
  ...
  if(USBSerial)
  {
    ...
    {
      Serial.println(F("VL sensor initialized!"));
    }
    if (! vl53statusrange) {
    ...
    {
        Serial.println(F("VL53 is ranging"));
    }
